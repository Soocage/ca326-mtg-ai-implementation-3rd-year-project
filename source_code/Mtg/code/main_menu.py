...
pointer_x, pointer_y = POINTER_BUTTON_X, POINTER_BUTTON_Y
pygame.init()
pygame.mixer.init()
...
def game_intro(gameDisplay, display_size):
    ...
    while in_intro:
        ...
        draw_button(fight_vs_ai, display_size)
        draw_button(quit, display_size)
        draw_button(option, display_size)
        draw_button(deck_tool, display_size)
        draw_button(login, display_size)
...
def option(gameDisplay, display_size):
    ...
    while in_option:
        ...
        draw_button(change_res, display_size)
        draw_button(back, display_size)
        draw_button(volume, display_size)
        draw_button(slider, display_size)
        draw_button(plus, display_size)
        draw_button(minus, display_size)
        draw_button(res_1, display_size)
        draw_button(res_2, display_size)
        draw_button(res_3, display_size)
        draw_button(res_4, display_size)
        draw_button(res_5, display_size)
...
def draw_button(name, display_size):
