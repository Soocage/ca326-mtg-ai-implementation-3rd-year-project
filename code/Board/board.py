...
class Player():
    ...
    def __init__(self, name, deck, graveyard=[], hand=[], life=20):
        self.deck = deck
        self.name = name
        self.life = int(life)
        self.hand = hand
...
def draw_board(display, display_w, display_h, player_1, player_2):
...
def main():
    ...
    ##display_w = int(info.current_w)
    ##display_h = int(info.current_h)
    display_w = 800
    display_h = 600
    ...
    player_1 = Player("Sean", deck_1)
    player_2 = Player("Kacper", deck_2)
    ...
    while not exitGame:
        ...
        draw_board(gameDisplay, display_w, display_h, player_1, player_2)
